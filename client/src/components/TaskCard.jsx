...
import { useSubTaskCompletedMutation } from "../redux/slices/api/taskApiSlice";
...
const TaskCard = ({ task, refetch }) => {
  ...
  const [completeSubTask, { isLoading }] = useSubTaskCompletedMutation();

  const toggleSubtaskCompletion = async (id, index) => {
    try {
